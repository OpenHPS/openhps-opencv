import { SourceNode, CameraObject, StereoCameraObject } from '@openhps/core';
import { StereoVideoFrame } from '../../data';
...
export class StereoVideoSource extends SourceNode<StereoVideoFrame> {
    ...
    constructor(sourceLeft?: CameraObject, sourceRight?: CameraObject) {
        super(new StereoCameraObject(sourceLeft, sourceRight));
    }
