...
// Both `./common` (which re-exports @openhps/video) and `./server` declare
...
export { ImageProcessingNode, ImageProcessingOptions } from './server/nodes/processing/ImageProcessingNode';
